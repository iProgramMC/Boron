...
typedef BSTATUS(*IO_MAKE_FILE_METHOD)   (PFILE_OBJECT* OutCreatedFileObject, PFCB ContainingFcb, PIO_DIRECTORY_ENTRY Name);
typedef BSTATUS(*IO_MAKE_DIR_METHOD)    (PFILE_OBJECT* OutCreatedFileObject, PFCB ContainingFcb, PIO_DIRECTORY_ENTRY Name);
typedef BSTATUS(*IO_MAKE_SYMLINK_METHOD)(PFILE_OBJECT* OutCreatedFileObject, PFCB ContainingFcb, PIO_DIRECTORY_ENTRY Name, const char* DestinationName, size_t DestinationNameLength);
