...
typedef union { struct { uint32_t b : 5, g : 5, r : 5, a : 1; } PACKED; uint32_t n; } COLOR_ARGB1555;
typedef union { struct { uint32_t r : 5, g : 5, b : 5, a : 1; } PACKED; uint32_t n; } COLOR_ABGR1555;
typedef union { struct { uint32_t b : 5, g : 6, r : 5; } PACKED; uint32_t n; } COLOR_RGB565;
typedef union { struct { uint32_t r : 5, g : 6, b : 5; } PACKED; uint32_t n; } COLOR_BGR565;
typedef union { struct { uint8_t i; }; uint32_t n; } COLOR_I8;
typedef union { struct { uint8_t p; }; uint32_t n; } COLOR_P8;
typedef union { struct { uint32_t i : 4; } PACKED; uint32_t n; } COLOR_I4;
